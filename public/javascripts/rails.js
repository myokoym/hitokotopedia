...
<meta content="3a8271f37727f9d5cfa11e2905f16097cc5b2ca1" name="csrf-token" />
  ...
  <body class="logged_out page-blob  env-production">
    ...
    <ul class="actions">
        ...
        <li>
          <a href="/rails/jquery-ujs/toggle_watch" class="minibutton btn-watch " id="watch_button" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', '3a8271f37727f9d5cfa11e2905f16097cc5b2ca1'); f.appendChild(s);f.submit();return false;" style="display:none"><span><span class="icon"></span>Watch</span></a>
          <a href="/rails/jquery-ujs/toggle_watch" class="minibutton btn-watch " id="unwatch_button" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', '3a8271f37727f9d5cfa11e2905f16097cc5b2ca1'); f.appendChild(s);f.submit();return false;" style="display:none"><span><span class="icon"></span>Unwatch</span></a>
            ...
            <li class="for-notforked" style="display:none"><a href="/rails/jquery-ujs/fork" class="minibutton btn-fork " id="fork_button" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', '3a8271f37727f9d5cfa11e2905f16097cc5b2ca1'); f.appendChild(s);f.submit();return false;"><span><span class="icon"></span>Fork</span></a></li>
  ...
  <ul>
    ...
    <div id="repo_details" class="metabox clearfix">
      ...
      <div id="repository_description_edit" style="display:none;" class="inline-edit">
        <form action="/rails/jquery-ujs/admin/update" method="post"><div style="margin:0;padding:0"><input name="authenticity_token" type="hidden" value="3a8271f37727f9d5cfa11e2905f16097cc5b2ca1" /></div>
    ...
    <div id="footer" >
      ...
      <div class="lower_footer">
        ...
        <![if !IE]><div id="legal"><![endif]>
              ...
              <p>&copy; 2011 <span id="_rrt" title="0.04647s from fe6.rs.github.com">GitHub</span> Inc. All rights reserved.</p>
